              ...
              {drawerLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  {drawerRules.map((rule) => (
                    <button
                      key={rule.id}
                      onClick={() => openRule(rule.id, rule.title)}
                      className="block w-full text-left rounded-xl border border-border bg-surface hover:border-primary/40 transition-colors p-4 group"
                    >
